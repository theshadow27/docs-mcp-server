...
import type { ScrapedPage, ScraperOptions } from "../types";
import {
...
describe("DefaultScraperStrategy", () => {
  ...
  describe("Page Scraping", () => {
    ...
    it("should add links to visited set immediately when queuing them", async () => {
      ...
      expect(visitedAddSpy.mock.calls).toContainEqual(["https://example.com/page1"]);
      expect(visitedAddSpy.mock.calls).toContainEqual(["https://example.com/page2"]);
